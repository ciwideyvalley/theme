...
<?php if ($sidebar_position == 'right') : ?>
    <div class="middle cols2 " style="background:<?php echo tfuse_middle_background();?>">
<?php endif;?>
<?php if ($sidebar_position == 'full') : ?>
    <div class="middle full_width" style="background:<?php echo tfuse_middle_background();?>">
<?php endif; ?> 
    <div class="container tf_room_types_reservations">
        <div class="content">
                <?php  while ( have_posts() ) : the_post();?>
                    <?php get_template_part('content','single-room');?>
