                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('Failure message', 'tfuse'),
                            ...
                            'type' => 'text'),
                        array('name' => __('Admin email', 'tfuse'),
                            'desc' => __('Use an email you verify often.New reservation notifications and also client replies will go to this email.', 'tfuse'),
                            'id' => 'tf_rf_email_from',
                            'value' => get_option('admin_email'),
                            'type' => 'text'),
                         array('name' => __('New reservation admin email template', 'tfuse'),
                            'desc' => __('This is the email the admin will receive when a new reservation is made. ', 'tfuse'),
                            'id' => 'tf_rf_new_res_admin_email_template',
                            'value' => 'A new reservation was made on the website. Reservation number:  [resnumber]',
                            'type' => 'textarea'),
                        array('name' => __('Client email subject', 'tfuse'),
                       ...
                       array('name' => __('Reservation confirmation email template', 'tfuse'),
                        ...
                        array('name' => __('Reservation approved email template', 'tfuse'),
                            'desc' => __('This email is received by the user after a reservation was confirmed from the <a href="' . admin_url( 'admin.php?page=tf_reservations_list' ) . '" target="_blank">'.__('User reservations','tfuse').'</a> page. It supports HTML and in order to display one of your form input values you need to copy/paste their shortcode in here.', 'tfuse'),
                        ...
                        array('name' => __('Reservation rejected email template', 'tfuse'),
                            'desc' => __('This email is received by the user after a reservation was rejected from the <a href="' . admin_url( 'admin.php?page=tf_reservations_list' ) . '" target="_blank">'.__('User reservations','tfuse').'</a> page. It supports HTML and in order to display one of your form input values you need to copy/paste their shortcode in here.', 'tfuse'),
