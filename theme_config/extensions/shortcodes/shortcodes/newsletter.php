        ...
        <h3 class="widget-title">' . $title . '</h3> 
                ...
                <form action="#" method="post" class="newsletter_subscription_form">
                    <div class="newsletter_text">'.$text.'</div>
                        <input type="text" value="" name="newsletter" id="newsletter" class="newsletter_subscription_email inputField" placeholder="'. __('Your email address', 'tfuse').'"/>
                        <button type="submit" value="'. __('Send','tfuse') .'" class="btn-form newsletter_subscription_submit"><span class="icon-caret-right"></span></button>
