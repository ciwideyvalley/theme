                    ...
                    <li data-transition="<?php echo $slide['slide_transition'];?>" data-slotamount="7" data-masterspeed="300">
                        ...
                        <?php if($slide_1):?>
                            <div class="caption <?php echo $slide['slide_animation1'];?> <?php echo $slide['slide_outanimation1'];?> <?php echo $slide['slide_type1'];?>"
                                 ...
                                 data-easing="easeOutExpo" data-end="<?php echo $slide['slide_end1'];?>" data-endspeed="300" data-endeasing="easeInSine"><?php echo $slide['slide_title1'];?>
                            </div>
                        <?php else:?>
                        ...
                        <?php if($slide_2):?>
                            <div class="caption <?php echo $slide['slide_animation2'];?> <?php echo $slide['slide_outanimation2'];?> <?php echo $slide['slide_type2'];?>"
                                 ...
                                 data-easing="easeOutExpo" data-end="<?php echo $slide['slide_end2'];?>" data-endspeed="300" data-endeasing="easeInSine"><?php echo $slide['slide_title2'];?>
                            </div>
                        <?php else:?>
                        ...
                        <?php if($slide_3):?>
                            <div class="caption <?php echo $slide['slide_animation3'];?> <?php echo $slide['slide_outanimation3'];?> <?php echo $slide['slide_type3'];?>"
                                 ...
                                 data-easing="easeOutExpo" data-end="<?php echo $slide['slide_end3'];?>" data-endspeed="300" data-endeasing="easeInSine"><?php echo $slide['slide_title3'];?>
                            </div>
                        <?php else:?>
