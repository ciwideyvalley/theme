...
$cfg['setup'] = array(
    array(
        'design' => 'code',
        'name' => __('Codecanyon Slider', 'tfuse')
    ),
    array(
        'design' => 'tabs',
        'name' => __('Tabs Slider', 'tfuse')
    ),
    array(
        'design' => 'codecanyonfull',
        'name' => __('Codecanyon Full Slider', 'tfuse')
    ),
    array(
        'design' => 'info',
        'name' => __('Tabs Info Slider', 'tfuse')
    ),
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            ...
                            'desc' => __('Choose the slider type. You can check the sliders in the ','tfuse').'<a target="_black" href="http://themefuse.com/demo/wp/medica/">'.__('demo live preview','tfuse').'</a>'.__(' on our website.','tfuse'),
