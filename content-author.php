...
?>
<h2 class="author_info"><?php _e('Author description','tfuse'); ?></h2>
<div class="author-description well clearfix">
    ...
    <div class="author-text">
        ...
        <p><strong><?php _e('About the author','tfuse'); ?>:</strong><?php if ( !empty($author_description) ) echo $author_description; ?></p>
